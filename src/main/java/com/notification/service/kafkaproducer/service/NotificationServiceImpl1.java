...
@Service
public class NotificationServiceImpl1 implements NotificationService {

    private static final ObjectMapper mapper = new ObjectMapper();
    private final BrokerProducerService brokerProducerService;
    private final Environment env;

    public NotificationServiceImpl1(BrokerProducerService brokerProducerService, Environment env) {
